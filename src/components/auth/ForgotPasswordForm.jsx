...
export default function ForgotPasswordForm() {
    ...
    const handleSubmit = (e) => {
        ...
        if (step === 3 && validateStep3()) {
            alert("Password reset successful! Connect backend/API next.");
        }
    };
    ...
    return (
        <section className="bg-[#f8fbfa] py-15 sm:py-10 lg:py-20">
                                ...
                                <>
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <button
                                            type="button"
                                            onClick={handleNext}
                                            className="w-1/2 h-[50px] rounded-2xl bg-[#0E6B68] text-white font-semibold hover:bg-[#0b5a57] transition shadow-md text-sm"
                                        >
                                            Verify OTP
                                        </button>
                                    </div>
                                ...
                                <>
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <button
                                            type="button"
                                            onClick={handleNext}
                                            className="w-1/2 h-[50px] rounded-2xl bg-[#0E6B68] text-white font-semibold hover:bg-[#0b5a57] transition shadow-md text-[15px]"
                                        >
                                            Verify OTP
                                        </button>
                                    </div>
